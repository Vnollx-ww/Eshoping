...
func NewClient(destService string, opts ...client.Option) (Client, error) {
	...
	return &kOrderListServiceClient{
...
type kOrderListServiceClient struct {
	*kClient
}

func (p *kOrderListServiceClient) AddOrder(ctx context.Context, req *orderlist.AddOrderRequest, callOptions ...callopt.Option) (r *orderlist.AddOrderResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.AddOrder(ctx, req)
}

func (p *kOrderListServiceClient) DelOrder(ctx context.Context, req *orderlist.DelOrderRequest, callOptions ...callopt.Option) (r *orderlist.DelOrderResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
